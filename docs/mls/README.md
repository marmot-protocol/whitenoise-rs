...
- `darkmatter-integration.md` - Integration details for the Darkmatter crates
...
- [Darkmatter](https://github.com/marmot-protocol/darkmatter)
...
3. **Implementation Details**: Check `darkmatter-integration.md` for library-specific patterns
